...
module lif_neuron_tb();
    ...
    initial begin
        $monitor("Spike1 = %b | Spike1Weight = %d || Spike2 = %b | Spike2Weight = %d || Spike3 = $b | Spike3Weight = %d | alpha = %d | CurrentPortential = %d | OutputSignal = %b", spike_in_1, spike_1_weight, spike_in_2, spike_2_weight, spike_in_3, spike_3_weight, alpha, uut.Current_Potential, spike_out);
